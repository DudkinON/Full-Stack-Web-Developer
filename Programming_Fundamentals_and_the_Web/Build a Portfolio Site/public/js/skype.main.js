var SkypeButton = new function () {
    ...
    this.trySkypeUri_IE9_IE8 = a;
    this.trySkypeUri_IOS_Safari = a;
    this.trySkypeUri_Android_Chrome = a;
    this.trySkypeUri_Android_Firefox = a;
    ...
    this.includeJavascript('https://swc.cdn.skype.com/sdk/0.10.47/sdk.min.js');
    ...
    function l(L) {
        ...
        if (!this.useDetection || (this.isWin8 && this.isIE10) || this.isIE7 || this.isIE6) {
            ...
            if ((this.isWinPhone8 && this.isIE10) || (this.isAndroid && this.isAndroidBrowser)) {
                A = "javascript://";
                v += " SkypeButton.displayNotSupportedMsg();"
            }
            else if (this.isAndroid && this.isChrome) {
                v = "SkypeButton.trySkypeUri_Android_Chrome('" + this.analyzeCrumbIndex + "');";
                A = B
            }
            else {
                y = "SkypeButton.trySkypeUri_Generic";
                if (this.isIE10 || this.isIE9 || this.isIE8) {
                    y = "SkypeButton.trySkypeUri_IE9_IE8"
                } else {
                    if ((this.isIOS7 || this.isIOS6 || this.isIOS5 || this.isIOS4) && this.isSafari) {
                        y = "SkypeButton.trySkypeUri_IOS_Safari"
                    } else {
                        if (this.isAndroid && this.isFF) {
                            y = "SkypeButton.trySkypeUri_Android_Firefox"
                        }
                    }
                }
        ...
        dummy.setAttribute('class', 'skype-button');
        dummy.setAttribute('style', 'pointer-events: none;');
        dummy.innerHTML = '<div></div>';
        N.appendChild(dummy);
        if (this.name === this.dropdownLinks.name) {
            z.setAttribute("onmouseover", "SkypeButton.showDropdown('dropdown_" + this.element + "'); return false;");
            z.setAttribute("onmouseout", "SkypeButton.hideDropdown('dropdown_" + this.element + "'); return false;");
            N.setAttribute("style", "cursor: text;");
            N.setAttribute("onfocus", "SkypeButton.showDropdown('dropdown_" + this.element + "'); return false;");
            N.setAttribute("onblur", "SkypeButton.hideDropdown('dropdown_" + this.element + "'); return false;");
            N.setAttribute("href", "javascript://");
            N.setAttribute("onclick", "return false;")
        } else {
            if (this.name === this.chatLinks.name) {
                if (this.participants.length === 1) {
                    v = "SkypeWebControl.SDK.Chat.startChat({ConversationType: 'person', ConversationId: '" + this.participants[0] + "'});"
                } else {
                    v = "SkypeButton.tryAnalyzeSkypeUri('chat', '" + this.analyzeCrumbIndex + "');" + v
                }
            } else {
                v = "SkypeButton.tryAnalyzeSkypeUri('call', '" + this.analyzeCrumbIndex + "');" + v
            }
        ...
        if (this.name === this.dropdownLinks.name) {
            ...
            r.setAttribute("onmouseover", "SkypeButton.showDropdown('dropdown_" + this.element + "'); return false;");
            r.setAttribute("onmouseout", "SkypeButton.hideDropdown('dropdown_" + this.element + "'); return false;");
            ...
            K = "SkypeButton.tryAnalyzeSkypeUri('dropdownCall', '" + this.analyzeCrumbIndex + "');" + v;
            ...
            I.setAttribute("onfocus", "SkypeButton.showDropdown('dropdown_" + this.element + "'); return false;");
            I.setAttribute("onblur", "SkypeButton.hideDropdown('dropdown_" + this.element + "'); return false;");
            var E = document.createElement("a");
            E.href = "javascript://";
            E.setAttribute("style", "text-decoration: none; color: #00AFF0; font-size: 16px;");
            E.setAttribute("href", A);
            K = "SkypeButton.tryAnalyzeSkypeUri('dropdownChat', '" + this.analyzeCrumbIndex + "');" + v;
            E.setAttribute("onmouseover", "this.style.textDecoration = 'underline'");
            E.setAttribute("onmouseout", "this.style.textDecoration = 'none'");
            I.setAttribute("role", "Menu item");
            E.setAttribute("onfocus", "SkypeButton.showDropdown('dropdown_" + this.element + "'); return false;");
            E.setAttribute("onblur", "SkypeButton.hideDropdown('dropdown_" + this.element + "'); return false;");
            if (this.participants.length === 1) {
                E.setAttribute("onclick", "SkypeWebControl.SDK.Chat.startChat({ConversationType: 'person', ConversationId: '" + this.participants[0] + "'});");
            } else {
    ...
    function n(s, w, u) {
        ...
        setTimeout(function () {
            ...
            if (v) {
                ...
                r.close();
                alert(SkypeButton.installSkypeMsg);
                SkypeButton.tryAnalyzeSkypeUri("redirect", u);
                window.location = SkypeButton.SkypeClientDownloadUrl
            }
        }, 100)
    }
    ...
    function e(s, v, t) {
        ...
        setTimeout(function () {
            if (u) {
                alert(SkypeButton.installSkypeMsg);
                SkypeButton.tryAnalyzeSkypeUri("redirect", t);
                window.location = SkypeButton.SkypeClientDownloadUrl
            }
        }, 2000)
    }
    ...
    function a_androidchrome(analyzeCrumbIndex) {
        ...
        setTimeout(function () {
            if (documentVisible) {
                alert(SkypeButton.installSkypeMsg);
                SkypeButton.tryAnalyzeSkypeUri("redirect", analyzeCrumbIndex);
                window.location = SkypeButton.SkypeClientDownloadUrl
            }
